...
yum -y install php72w php72w-opcache php72w-bcmath php72w-xml php72w-mcrypt php72w-gd php72w-devel php72w-mysql php72w-intl php72w-mbstring php72w-soap php72w-pgsql
