...
yum -y install php55w php55w-opcache php55w-bcmath php55w-xml php55w-mcrypt php55w-gd php55w-devel php55w-mysql php55w-intl php55w-mbstring php55w-soap mod_ssl
mkdir /var/www/hosts
